...
class DeepSpeedEngine(Module):
    ...
    def __init__(
        ...
        if has_optimizer:
            self._configure_optimizer(optimizer, model_parameters, args)
    ...
    # Configure optimizer
    def _configure_optimizer(self, client_optimizer, model_parameters, args):
        ...
        if optimizer_wrapper == ZERO_OPTIMIZATION:
            self.optimizer = self._configure_zero_optimizer(basic_optimizer, args)
    ...
    def _configure_zero_optimizer(self, optimizer, args):
