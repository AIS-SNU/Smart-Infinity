            ...
            if args.opt_type == 0: # Adam
                ...
                if args.use_fpga == 1:
                    ...
                    optimizer = cpu_adam_optimizer( param_groups,
                                                   ...
                                                   weight_decay=args.weight_decay,
                                                   opt_type = args.opt_type )
                elif args.use_fpga == 0:
                    from deepspeed.ops.adagrad import DeepSpeedCPUAdagrad
                    cpu_adam_optimizer = DeepSpeedCPUAdagrad
                    optimizer = cpu_adam_optimizer(param_groups,
                                                   lr=args.lr,
                                                   weight_decay=args.weight_decay)

            elif args.opt_type == 2: # SGD Momentum
                from deepspeed.ops.adam import DeepSpeedCPUAdam
                cpu_adam_optimizer = DeepSpeedCPUAdam
                optimizer = cpu_adam_optimizer( param_groups,
                                               lr=args.lr,
...
def setup_model_and_optimizer(model_provider_func):
    ...
    if args.deepspeed:
        ...
        print(mpu)
        print('DP:',mpu.get_data_parallel_world_size())
        print('TP:',mpu.get_model_parallel_world_size())
        #raise NotImplementedError
...
def train_step(forward_step_func, data_iterator,
    ...
    #print('[Rank=',torch.distributed.get_rank(),'] backward complete!')
